...
// LayeredText (21st.dev/xubohuah). Mantido como o spec; ajuste único: a cor sai
// do componente (era text-black dark:text-white) e vem do parent via className —
// o dark mode aqui é via [data-theme], não a variante `dark:`. No hero passamos
// text-white. "use client" + gsap (já instalado).
...
export function LayeredText({
  lines = [
    { top: " ", bottom: "FUTURO" },
    { top: "FUTURO", bottom: "SISTEMA" },
    { top: "SISTEMA", bottom: "ESTRUTURA" },
    { top: "ESTRUTURA", bottom: "CONTROLE" },
    { top: "CONTROLE", bottom: "RESULTADO" },
    { top: "RESULTADO", bottom: "DOMINIO" },
    { top: "DOMINIO", bottom: " " },
  ],
  fontSize = "72px",
  fontSizeMd = "36px",
